...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.renderWebp = function () {
        return (React.createElement("source", { type: "image/webp", className: this.props.className, src: this.props.webpSrc || this.replaceWithWebp(this.props.src), srcSet: this.buildSrcSet(true), sizes: this.buildSizes() }));
    };
